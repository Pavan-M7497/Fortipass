      ...
      >
        ...
        <form onSubmit={handleSignup} className="space-y-5">
          ...
          <button
            type="submit"
            disabled={isLoading}
            className="flex items-center justify-center w-full gap-2 py-4 mt-8 font-semibold text-white transition-all rounded-xl bg-purple-glow hover:bg-purple-500 disabled:opacity-50 hover:shadow-[var(--shadow-glow-purple)]"
          >
